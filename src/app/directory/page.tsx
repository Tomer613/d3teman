...
import { HalachicStatus, MemberProfile } from "@/types";

// Mock community members data
const MOCK_MEMBERS: MemberProfile[] = [
    {
        id: "1",
        email: "yosef.s@example.com",
        firstName: "יוסף",
        lastName: "שרעבי",
        phone: "050-1234567",
        address: { street: "שבזי 14", city: "בני ברק" },
        halachicStatus: "kohen",
        role: "member",
        isApproved: true,
        children: [
            { ageGroup: "elementary", count: 2 },
            { ageGroup: "teen", count: 1 },
        ],
        yahrzeits: [],
        privacy: {
    ...
    {
        id: "2",
        email: "yitzchak.m@example.com",
        firstName: "יצחק",
        lastName: "מחפוד",
        phone: "052-7654321",
        address: { street: "הארי 8", city: "בני ברק" },
        halachicStatus: "levi",
        role: "gabay",
        isApproved: true,
        children: [{ ageGroup: "elementary", count: 3 }],
        yahrzeits: [],
        privacy: {
            showPhoneInDirectory: true,
    ...
    {
        id: "3",
        email: "avraham.tz@example.com",
        firstName: "אברהם",
        lastName: "צדוק",
        phone: "054-9876543",
        address: { street: "יהודה הנשיא 22", city: "בני ברק" },
        halachicStatus: "yisrael",
        role: "member",
        isApproved: true,
        children: [{ ageGroup: "toddler", count: 2 }],
        yahrzeits: [],
        privacy: {
    ...
    {
        id: "4",
        email: "shimon.g@example.com",
        firstName: "שמעון",
        lastName: "גמליאל",
        phone: "053-3344556",
        address: { street: "שבזי 3", city: "בני ברק" },
        halachicStatus: "yisrael",
        role: "member",
        isApproved: true,
        children: [{ ageGroup: "teen", count: 2 }],
        yahrzeits: [],
        privacy: {
            showPhoneInDirectory: true,
            showAddressInDirectory: true,
...
export default function DirectoryPage() {
    ...
    const filteredMembers = useMemo(() => {
        return MOCK_MEMBERS.filter((member) => {
            ...
            const matchesSearch =
                ...
                member.address.street.includes(searchQuery) ||
    ...
    const getStatusBadge = (status: HalachicStatus) => {
        switch (status) {
            case "kohen":
                        ...
                        >
                            <div>
                                <div className="flex items-start justify-between mb-3">
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 mt-0.5">
                                            {member.privacy.showAddressInDirectory
                                ...
                                <div className="text-xs text-slate-600 space-y-1 mb-4">
                                    {member.privacy.showPhoneInDirectory ? (
