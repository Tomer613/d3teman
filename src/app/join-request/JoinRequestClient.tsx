...
interface JoinRequestClientProps {
    // Only shown to a genuinely anonymous visitor - a logged-in visitor
    // already has the full nav (GatedHeader) rendered above this component.
    showBackToLogin: boolean;
}

export default function JoinRequestClient({ showBackToLogin }: JoinRequestClientProps) {
